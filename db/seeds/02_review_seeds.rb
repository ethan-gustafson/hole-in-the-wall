# 1
saigon_bistro = Review.create(:title => "High quality food!", 
...
# 3
saigon_bistro_3 = Review.create(:title => "Lovely Service",
...
# 4
hot_dog_heaven = Review.create(:title => "This Really is Heaven",
...
# 5
hot_dog_heaven_2 = Review.create(:title => "Long line: Worth it",
...
# 6
hot_dog_heaven_3 = Review.create(:title => "What kind of food is this?",
...
# 7
mannys_pizza_house = Review.create(:title => "My Favorite Pizza Place",
...
# 8
mannys_pizza_house_2 = Review.create(:title => "Wow!",
...
# 9
mannys_pizza_house_3 = Review.create(:title => "Best Pizza I have ever had!",
